...
def MarvellousTitanicLogistic():
    ...
    countplot(data=titanic_data,x=target,hue="Sex").set_title("Marvellous Infosystems:Survived and non srvieved passangers based on gender")
    show()
    ...
    countplot(data=titanic_data,x=target, hue="Pclass").set_title("Marvellous Infosystems :survived and non survived passangers based  on the Passanger class:")
    show()


    print("Visualisation : Survived and non survied passangers based on Age")
    figure()
    titanic_data["Age"].plot.hist().set_title("Marvellous Infosystems : Survived and non survied passangers base on Age")
    show()
